...
from E01.Example.Classes.Global.Manager.CTimeManager import *
from E01.Example.Classes.Global.Manager.CInputManager import *

from E01.Practice.Classes.Practice_15.CP15Ball import *
from E01.Practice.Classes.Practice_15.CP15Turret import *
...
class CPractice_15(QMainWindow, uic.loadUiType("Resources/Practice_15/P15MainWindow.ui")[0]):
	...
	def __init__(self):
		...
		self.m_oTurret = CP15Turret(self)
		self.m_oBallList = []
