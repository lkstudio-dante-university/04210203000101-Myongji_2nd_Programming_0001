...
class CE07UserInfoStorage:
	...
	def LoadUserInfo(self):
		...
		"""
		# 파일이 존재 할 경우
		if os.path.isfile("Resources/Example_07/E07_01.txt"):
			"""
			open 메서드란?
			...
			"""
			with open("Resources/Example_07/E07_01.txt", "r") as oRStream:
				"""
	...
	def SaveUserInfo(self):
		...
		"""
		# 디렉토리가 없을 경우
		if not os.path.isdir("Resources/Example_07"):
			os.makedirs("Resources/Example_07")
		
		with open("Resources/Example_07/E07_01.txt", "w") as oWStream:
