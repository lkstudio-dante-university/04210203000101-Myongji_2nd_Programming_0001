...
# Example 15
class CExample_15(QMainWindow, uic.loadUiType("Resources/Example_15/E15MainWindow.ui")[0]):
	# 생성자
	def __init__(self):
		super().__init__()
		self.__init__Example_15__()
	
	# 초기화
	def __init__Example_15__(self):
		self.show()
		self.setupUi(self)
		self.setWindowTitle("Example 14")
