...
# Example 14
class CExample_14(QMainWindow, uic.loadUiType("Resources/Example_14/E14MainWindow.ui")[0]):
	# 생성자
	def __init__(self):
		super().__init__()
		self.__init__example_14__()
	
	# 초기화
	def __init__example_14__(self):
		self.show()
		self.setupUi(self)
