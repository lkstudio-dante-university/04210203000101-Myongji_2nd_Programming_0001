...
namespace E01 {
	/** 해상도 처리자 */
	public partial class CE01ResolutionHandler : CE01Component {
		#region 변수
		...
		public float PlaneDistance {
			get {
				...
				float fHeight = KE01Define.G_DESIGN_SCREEN_HEIGHT / 2.0f;
		...
		public float OrthographicSize => KE01Define.G_DESIGN_SCREEN_HEIGHT / 2.0f;
		#endregion // 프로퍼티
