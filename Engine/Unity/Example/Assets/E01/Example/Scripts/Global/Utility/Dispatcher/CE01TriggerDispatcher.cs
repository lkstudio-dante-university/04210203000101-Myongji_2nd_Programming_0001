...
namespace E01 {
	...
	public partial class CE01TriggerDispatcher : CE01Component {
		...
		public System.Action<CE01TriggerDispatcher, Collider2D> Enter2DCallback { get; private set; } = null;
		public System.Action<CE01TriggerDispatcher, Collider2D> Stay2DCallback { get; private set; } = null;
		public System.Action<CE01TriggerDispatcher, Collider2D> Exit2DCallback { get; private set; } = null;
		#endregion // 프로퍼티
		...
		#region 접근 함수
		/** 시작 콜백을 변경한다 */
		public void SetEnterCallback(System.Action<CE01TriggerDispatcher, Collider> a_oCallback) {
			this.EnterCallback = a_oCallback;
		}

		/** 진행 콜백을 변경한다 */
		public void SetStayCallback(System.Action<CE01TriggerDispatcher, Collider> a_oCallback) {
			this.StayCallback = a_oCallback;
		}

		/** 종료 콜백을 변경한다 */
		public void SetExitCallback(System.Action<CE01TriggerDispatcher, Collider> a_oCallback) {
			this.ExitCallback = a_oCallback;
		}

		/** 시작 콜백을 변경한다 */
		public void SetEnter2DCallback(System.Action<CE01TriggerDispatcher, Collider2D> a_oCallback) {
			this.Enter2DCallback = a_oCallback;
		}

		/** 진행 콜백을 변경한다 */
		public void SetStay2DCallback(System.Action<CE01TriggerDispatcher, Collider2D> a_oCallback) {
			this.Stay2DCallback = a_oCallback;
		}

		/** 종료 콜백을 변경한다 */
		public void SetExit2DCallback(System.Action<CE01TriggerDispatcher, Collider2D> a_oCallback) {
