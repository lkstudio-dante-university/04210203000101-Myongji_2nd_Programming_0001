...
namespace E01 {
	/** 상태 */
	public class CE01State_23 {
		#region 프로퍼티
		public CE01Monster_23 Owner { get; private set; } = null;
		#endregion // 프로퍼티
		...
		/** 소유자를 변경한다 */
		public void SetOwner(CE01Monster_23 a_oOwner) {
			this.Owner = a_oOwner;
		}
		#endregion // 함수
	}
	...
	/** 상태 머신 */
	public class CE01State_23Machine {
		#region 프로퍼티
		public CE01State_23 State { get; private set; } = null;
		public CE01Monster_23 Owner { get; private set; } = null;
		#endregion // 프로퍼티
		...
		/** 상태를 변경한다 */
		public void SetState(CE01State_23 a_oState) {
			// 상태 변경이 가능 할 경우
