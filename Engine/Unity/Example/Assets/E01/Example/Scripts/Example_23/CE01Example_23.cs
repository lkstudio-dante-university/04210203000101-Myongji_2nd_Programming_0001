...
namespace E01 {
	/** Example 23 */
	public class CE01Example_23 : CE01SceneManager {
		/** 상태 */
		public enum EState {
			NONE = -1,
			PLAY,
		...
		#region 프로퍼티
		public override string SceneName => KE01Define.G_SCENE_N_EXAMPLE_23;
		...
		public void HandleOnDeathPlayer() {
			...
			CE01SceneLoader.Inst.LoadScene(KE01Define.G_SCENE_N_EXAMPLE_24, false);
		}
