...
namespace E01 {
	/** Example 18 */
	public partial class CE01Example_18 : CE01SceneManager {
		/** 상태 */
		private enum EState {
			NONE = -1,
			PLAY,
		...
		#region 프로퍼티
		public override string SceneName => KE01Define.G_SCENE_N_EXAMPLE_18;
		#endregion // 프로퍼티
		...
		public override void Update() {
			...
			if(m_fRemainTime <= float.Epsilon) {
				...
				CE01SceneLoader.Inst.LoadScene(KE01Define.G_SCENE_N_EXAMPLE_19, false);
			}
