 ...
 * 
 * Ex)
 * public virtual void SomeVirtualMethod(int a_nVal01, int a_nVal02) {
 *     // Do Something
 * }
 */
namespace E01 {
	...
	/** Example 9 */
	public partial class CE01Example_09 : CE01SceneManager {
		#region 프로퍼티
		public override string SceneName => KE01Define.G_SCENE_N_EXAMPLE_09;
		#endregion // 프로퍼티
